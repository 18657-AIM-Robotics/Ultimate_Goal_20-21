...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.65753424657; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.04347826087; // Multiplier in the Y direction
